...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(fazendaOliveira.obterSomatorioPrecoAnimaisAbate());
        fazendaOliveira.situacaoFinanceira();
        System.out.println(fazendaOliveira.getReceitaDaFazenda());
        System.out.println(fazendaOliveira.getValorTotalSalarios());
