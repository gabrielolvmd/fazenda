...
public class Fazenda implements InterfaceFazenda {
  ...
  public void calcularSalarioFuncionarios() {
    ...
    System.out.printf("A folha de pagamento desse mês está em R$ %f \n" + //
  ...
  public void situacaoFinanceira() {
    ...
    if (saldoAtual < 0) {
      System.out.printf("A fazenda está tendo prejuízo. Saldo atual é de %f \n" + //
          "", saldoAtual);
    } else {
      System.out.printf("A fazenda está em situação de lucro com um saldo de %f \n", saldoAtual);
    }
  }
